...
class HeatingStatus(models.Model):
    ...
    status = models.CharField(max_length=3, choices=STATUS_CHOICES, default='off')  # Включено/выключено
    temperature = models.IntegerField(default=20)  # Температура отопления
